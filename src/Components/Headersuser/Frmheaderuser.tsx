...
const Frmheaderuser: FC = () => {
    ...
    async function Logout() {
        ...
        if (conF == true) {
            axios.patch(API.returnURL.url + "Login/logout?personID=" + sessionStorage.getItem('sessID'))
    ...
    async function Notimessage() {
        ...
        const rs = await
            axios.get(API.returnURL.url + "Dashboard/ShowmessageAdmin?userStr=" + sessionStorage.getItem('sessStr') + "&userID=" + sessionStorage.getItem('sessID'))
            ...
            <nav className="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div className="navbar-collapse collapse" >\
                    <ul className="navbar-nav float-start me-auto">
                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <span className="d-none d-md-block font-18" >Create New <i className="fa fa-angle-down font-18" /></span>
                        ...
                        <li className="nav-item search-box">
                            <a className="nav-link waves-effect waves-dark" href="javascript:void(0)"><i className="mdi mdi-magnify fs-2" /></a>
                    ...
                    <ul className="navbar-nav float-end">
                        <span className="user-name">{sessionStorage.getItem('sessName')}</span>
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle waves-effect waves-dark" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <div className="">
                                            <a href="javascript:void(0)" className="link border-top">
                                                <div className="d-flex no-block align-items-center p-10">
                                                    <span className="btn btn-success btn-circle d-flex align-items-center justify-content-center"><i className="mdi mdi-calendar text-white fs-4" /></span>
                                                    <div className="ms-2">
                                            ...
                                            <a href="javascript:void(0)" className="link border-top">
                                                <div className="d-flex no-block align-items-center p-10">
                                                    <span className="btn btn-info btn-circle d-flex align-items-center justify-content-center"><i className="mdi mdi-settings fs-4" /></span>
                                                    <div className="ms-2">
                                            ...
                                            <a href="javascript:void(0)" className="link border-top">
                                                <div className="d-flex no-block align-items-center p-10">
                                                    <span className="btn btn-primary btn-circle d-flex align-items-center justify-content-center"><i className="mdi mdi-account fs-4" /></span>
                                                    <div className="ms-2">
                                            ...
                                            <a href="javascript:void(0)" className="link border-top">
                                                <div className="d-flex no-block align-items-center p-10">
                                                    <span className="btn btn-danger btn-circle d-flex align-items-center justify-content-center"><i className="mdi mdi-link fs-4" /></span>
                                                    <div className="ms-2">
                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="../../src/assets/images/users/1.jpg" alt="user" className="rounded-circle" width={31} />
                            </a>
                            <ul className="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">

                                <div className="dropdown-divider" />
                                <a className="dropdown-item" href="/User/FrmProfile"><i className="dw dw-user1" /> <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 24 24">
                                ...
                                <a className="dropdown-item" href="#"><i className="dw dw-settings2" /> <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 16 16">
                                ...
                                <a className="dropdown-item" href="#"><i className="dw dw-help" /> <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 24 24">
                                    <g fill="none" stroke="#6f6e6e" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.9}>
                                        <path d="M3 12a9 9 0 1 0 18 0a9 9 0 1 0-18 0m9 5v.01"></path>
                                        <path d="M12 13.5a1.5 1.5 0 0 1 1-1.5a2.6 2.6 0 1 0-3-4"></path>
                                    </g>
                                </svg>&nbsp;  ความช่วยเหลือ</a>
                                <a className="dropdown-item" href="#" onClick={() => Logout()}><i className="dw dw-logout" /> <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 24 24">
                                    <path fill="#6f6e6e" d="M5 22a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v3h-2V4H6v16h12v-2h2v3a1 1 0 0 1-1 1zm13-6v-3h-7v-2h7V8l5 4z"></path>
                                </svg>&nbsp;  ออกจากระบบ </a>
