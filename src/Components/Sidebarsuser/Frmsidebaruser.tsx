        ...
        <nav className="sidebar-nav">
          <ul id="sidebarnav" className="pt-4">
            ...
            <li className="sidebar-item">
              ...
              <ul aria-expanded="false" className="collapse first-level">
                <li className="sidebar-item">
                  <a href="/user/Lendinguser" className="sidebar-link">
                    <span className="hide-menu"> &nbsp; - ยืมครุภัณฑ์คอมพิวเตอร์ </span></a>
                </li>
                <li className="sidebar-item">
                  <a href="/user/Returnequipmentuser" className="sidebar-link">
            ...
            <li className="sidebar-item">
              ...
              <ul aria-expanded="false" className="collapse first-level">
                <li className="sidebar-item">
                  <a href="/user/Informrepairuser" className="sidebar-link">
                    <span className="hide-menu">&nbsp;  - ขอโปรแกรม / รายงาน </span></a>
                </li>
                <li className="sidebar-item">
                  <a href="/user/Reportaproblemuser" className="sidebar-link">
                ...
                {/* <li className="sidebar-item">
                  <a href="/user/Jobdescriptionuser" className="sidebar-link">
