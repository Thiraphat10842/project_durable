...
import ReportaproblemuserAdd from './frmreportaproblemuserAdd'
...
const frmreportaproblemuser: FC = () => {
    ...
    return (
        <div>
            ...
            >
                {formType === "add" ? (
                    <ReportaproblemuserAdd datadetail={datadetail} countS={countS} setReload={setReload} reload={reload} />
                ) : (
...
export default frmreportaproblemuser;
