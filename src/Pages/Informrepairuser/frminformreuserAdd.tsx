...
const frminformrepairuserAdd: FC<userProps> = ({
  datadetail,
  countS,
  reload,
  setReload,
  ...
  async function Showlistpersonnelit() {
    axios
      .get(API.returnURL.url + "Informrepair/personnalSte3")
  ...
  return (
    <div>
      <form>
        ...
        <div className="row">
        <div className="form-group">
              <label>ชื่อผู้ขอรายงานที่จะให้แสดงสถานะการขอ  </label>
              <Select
                value={listpersonnelit.find(
                  (obj: any) => obj.value === inputdata.tRepairusername2
                )}
        ...
        <div className="row">
            ...
            <div className="form-group">
              ...
              <div className="row">
                <div className="d-flex flex-wrap">
                  ...
                  <input type="text" className="form-control" id="tOther" placeholder="อื่นๆ...." 
                  value={inputdata.tOther} onChange={(even) => setInputdata({ ...inputdata, tOther: even.target.value })} 
                  />
                </div>
              </div>
            </div>
          ...
          <div className="col-md-4 col-sm-12" hidden={strhidden}>
            <div className="form-group">
              <label>กำหนดวันเริ่มของโปรแกรมเมอร์</label>
              <input
      type="date"
      className="form-control"
      id="tDatestart"
      value={inputdata.tDatestart || ""}
      onChange={(even) => setInputdata({
        ...inputdata,
        tDatestart: even.target.value,
      })}
    />
            </div>
          </div>
...
export default frminformrepairuserAdd;
