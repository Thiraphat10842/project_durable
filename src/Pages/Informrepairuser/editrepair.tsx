...
const editrepairuser : FC<userProps> = ({
  datadetail,
  countS,
  reload,
  setReload,
    ...
    <div>
      <form>
        <div className="row" hidden={strhidden}>
          ...
          <div className="col-md-6 col-sm-4">
            <div className="form-group"hidden={strhidden}>
        ...
        <div className="row">
          ...
          <div className="col-md-4 col-sm-12" hidden={strhidden}>
            <div className="form-group">
              ...
              <Select
                value={listpersonnelit.find(
                  (obj: any) => obj.value === inputdata.tRepairuserid3
                )}
                options={listpersonnelit}
                styles={customStyles}
                onChange={(even: any) =>
                  setInputdata({
                    ...inputdata,
                    tRepairuserid3: even?.value,
                    tRepairusername3: even?.label,
                  })
                }
              />
            </div>
