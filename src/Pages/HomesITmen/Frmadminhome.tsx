                        ...
                        <div className="card">
                            ...
                            <div className="comment-widgets scrollable">
                                ...
                                <div className="d-flex flex-row comment-row mt-0">
                                    <div className="p-2">
                                        <img src="../src/assets/images/users/1.jpg" alt="user" width={50} className="rounded-circle" />
                                    </div>
                                ...
                                <div className="d-flex flex-row comment-row">
                                    <div className="p-2">
                                        <img src="../src/assets/images/users/4.jpg" alt="user" width={50} className="rounded-circle" />
                                    </div>
                                ...
                                <div className="d-flex flex-row comment-row">
                                    <div className="p-2">
                                        <img src="../src/assets/images/users/5.jpg" alt="user" width={50} className="rounded-circle" />
                                    </div>
                                    <div className="comment-text w-100">
                                        ...
                                        <li className="list-group-item todo-item" data-role="task">
                                            ...
                                            <ul className="list-style-none assignedto">
                                                <li className="assignee">
                                                    <img className="rounded-circle" width={40} src="../src/assets/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" data-original-title="Steave" />
                                                </li>
                                                <li className="assignee">
                                                    <img className="rounded-circle" width={40} src="../src/assets/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" data-original-title="Jessica" />
                                                </li>
                                                <li className="assignee">
                                                    <img className="rounded-circle" width={40} src="../src/assets/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" data-original-title="Priyanka" />
                                                </li>
                                                <li className="assignee">
                                                    <img className="rounded-circle" width={40} src="../src/assets/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" data-original-title="Selina" />
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="list-group-item todo-item" data-role="task">
                                    ...
                                    <ul className="chat-list">
                                        ...
                                        <li className="chat-item">
                                            <div className="chat-img">
                                                <img src="../src/assets/images/users/1.jpg" alt="user" />
                                            </div>
                                        ...
                                        <li className="chat-item">
                                            <div className="chat-img">
                                                <img src="../src/assets/images/users/2.jpg" alt="user" />
                                            </div>
                                            <div className="chat-content">
                                        ...
                                        <li className="chat-item">
                                            <div className="chat-img">
                                                <img src="../src/assets/images/users/3.jpg" alt="user" />
                                            </div>
                                            <div className="chat-content">
                            ...
                            <div className="tab-content tabcontent-border">
                                <div className="tab-pane active" id="home" role="tabpanel">
                                    <div className="p-20">
                                        ...
                                        <img src="../src/assets/images/background/img4.jpg" className="img-fluid" />
                                    </div>
                                </div>
