...
import Frmadd from './FrmdurableuserAdd';
import { toast } from "react-toastify";
import Select from 'react-select';
import './durable.css'

const Frmdurableuser: FC = () => {
                ...
                rows = Mydata.map((row: any, key: number) => ({
                    ...
                    Edit: (
                        <div style={{ float: 'left' }}>
                            <button className="btn btn-default btn-xs m-r-5" style={{ cursor: 'pointer' }} data-toggle="tooltip" data-original-title="Edit" onClick={() => (Showdetail(row.ID), setOpen(true))} ><i className="me-2 mdi mdi-pencil" />รายละเอียด</button>
    ...
    return (
        <div>
            ...
            >
                ...
                <Frmadd datadetail={datadetail} countS={countS} />
