...
const FrmInformrepairITmen: FC<userProps> = ({
  datadetail,
  countS,
  reload,
  setReload,
            ...
            <div className="form-group">
              ...
              <Select
                value={listpersonnelit.find(
                  (obj: any) => obj.value === inputdata.tRepairuserid1
                )}
                ...
                onChange={(even: any) =>
                  setInputdata({
                    ...inputdata,
                    tRepairuserid1: even?.value,
                    tRepairusername1: even?.label,
                  })
                }
              />
            </div>
...
export default FrmInformrepairITmen;
