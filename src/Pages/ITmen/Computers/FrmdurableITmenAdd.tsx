...
const FrmdurableITmenAdd: FC<userProps> = ({ datadetail, countS }) => {
            ...
            <form>
                <div className="form-row col-md-12 col-sm-12 row">
                    <div className="form-group col-md-3">
                        ...
                        <input type="text" className="form-control" id="tdurableid" placeholder="เลขครุภัณฑ์" value={inputvalue.tdurableID} onChange={(event) => setInputvalue({ ...inputvalue, tdurableID: event.target.value })} />
                    </div>

                    <div className='form-group col-md-5'>
                        <label>ชื่อครุภัณฑ์<sup className='text-danger h6'> * </sup></label>
                        <input type="text" className='form-control' id='tname' placeholder='ชื่อครุภัณฑ์' value={inputvalue.tname} onChange={(event) => setInputvalue({ ...inputvalue, tname: event.target.value })} />
                    </div>
                    ...
                    <div className="form-group col-md-4">
                        ...
                        <Select
                            ...
                            options={Arr}
                            styles={customStyles}
                            onChange={(selectedOption) => setInputvalue({ ...inputvalue, treceiving: selectedOption?.value || "" })}
                        />
                        {inputvalue.treceiving === '9' || inputvalue.treceiving === 'อื่นๆ' ? (
                            <input type="text" className="form-control mt-2" id='treceivingother' placeholder="โปรดระบุ" value={inputvalue.treceivingother} onChange={(event) => setInputvalue({ ...inputvalue, treceivingother: event.target.value })} />
                        ) : null}
                    </div>
                ...
                <div className='form-row col-md-12 col-sm-12 row'>
                    <div className="form-group col-md-4">
                        ...
                        <input type="text" className="form-control" id="tbrand" placeholder='ชื่อยี่ห้อ' value={inputvalue.tbrand} onChange={(even) => setInputvalue({ ...inputvalue, tbrand: even.target.value })} />
                    </div>
                    <div className="form-group col-md-4">
                        <label>รุ่น<sup className='text-danger h6'> * </sup></label>
                        <input type="text" className="form-control" id="tgeneration" placeholder='ชื่อรุ่น' value={inputvalue.tgeneration} onChange={(even) => setInputvalue({ ...inputvalue, tgeneration: even.target.value })} />
                    </div>
                    <div className="form-group col-md-4">
                        <label >ราคา</label>
                        <input type="text" className="form-control" id="tprice" placeholder='ราคา' value={inputvalue.tprice} onChange={(even) => setInputvalue({ ...inputvalue, tprice: even.target.value })} />
                    </div>
                ...
                <div className='form-row col-md-12 col-sm-12 row'>
                    <div className="form-group col-md-6">
                        ...
                        <input type="text" className="form-control" id="tserialnumer" placeholder="เลข Device ID" value={inputvalue.tserialnumer} onChange={(even) => setInputvalue({ ...inputvalue, tserialnumer: even.target.value })} />
                    </div>
                    <div className='form-group col-md-6'>
                        <label>IP Address</label>
                        <input type="text" className='form-control' id="ipaddress" placeholder='เลข IP' value={inputvalue.ipaddress} onChange={(even) => setInputvalue({ ...inputvalue, ipaddress: even.target.value })} />
                    </div>
                </div>
                ...
                <div className="form-row col-md-12 col-sm-12 row">
                    <div className="form-group col-md-4">
                        ...
                        <input type="date" className="form-control" id="treceivedate" value={inputvalue.treceivedate} onChange={(even) => setInputvalue({ ...inputvalue, treceivedate: even.target.value })} />
                    </div>
                    <div className="form-group col-md-4">
                        <label>วันที่ใช้ครั้งแรก<sup className='text-danger h6'> * </sup></label>
                        <input type="date" className="form-control" id="tusedate" value={inputvalue.tusedate} onChange={(even) => setInputvalue({ ...inputvalue, tusedate: even.target.value })} />
                    </div>
                    <div className="form-group col-md-4">
                        ...
                        <Select
                            ...
                            styles={customStyles}
                            onChange={(even: any) => setInputvalue({ ...inputvalue, tcategoryid: even?.value, tcategoryname: even?.label })}
                        />
                    </div>
                </div>
                ...
                <div className="form-row">
                    <div className="form-group col-md-12">
                        ...
                        <input type="text" className="form-control" placeholder='ชื่อ - นามสกุล' id="tOwner" value={inputvalue.tOwner} onChange={(even) => setInputvalue({ ...inputvalue, tOwner: even.target.value })} />
                    </div>
                ...
                <div className='form-row mb-3'>
                    <div className='form-group'>
                        ...
                        <input type="file" className='form-control form-control-sm ' id='tfile' onChange={(even: any) => setInputvalue({ ...inputvalue, Images: even.target.files[0] })} />
...
export default FrmdurableITmenAdd