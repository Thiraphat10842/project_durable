...
import ReportaproblemITmenAdd from './frmreportaproblemITmenAdd'
...
const frmreportaproblemITmen: FC = () => {
    ...
    return (
        <div>
            ...
            >
                {formType === "add" ? (
                    <ReportaproblemITmenAdd datadetail={datadetail} countS={countS} setReload={setReload} reload={reload} />
                ) : (
...
export default frmreportaproblemITmen;
