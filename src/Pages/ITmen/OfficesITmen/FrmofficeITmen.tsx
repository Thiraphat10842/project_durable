...
import FrmofficeITmenAdd from './FrmofficeITmenAdd';
import { toast } from "react-toastify";
import EditofficeAdd from './editofficeAdd';  // นำเข้า EditofficeAdd

const FrmofficeITmen: FC = () => {
    ...
    return (
        <div>
            ...
            >
                ...
                {countS === 0 ? (
                    <FrmofficeITmenAdd datadetail={datadetail} countS={countS} />
                ) : (
