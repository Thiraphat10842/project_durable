...
import ReturnequipmentAdd from "./frmreturnequipmentAdd";

function frmreturnequipment() {
  ...
  async function ShoweditLend(Lendid: string) {
    axios
      .get(API.returnURL.url + "Lending/Showeditrt?Lendid=" + Lendid)
      .then(function (response) {
  ...
  // function getDate(todate: string | undefined | null) {
  //     if (!todate) {
  //         return '';
  //     }
  //     else {
...
export default frmreturnequipment;
